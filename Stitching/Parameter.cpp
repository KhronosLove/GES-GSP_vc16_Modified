...
Parameter::Parameter(const string& _file_dir, const string& _file_name) {

	file_name = _file_name;
	file_dir = _file_dir + _file_name + "/";
	result_dir = _file_dir+"/0_results/" + _file_name + "-result/";

	_mkdir((_file_dir+"/0_results/").c_str());
	_mkdir(result_dir.c_str());
#ifndef DP_NO_LOG
	debug_dir = _file_dir +"/1_debugs/" + _file_name + "-result/";
	_mkdir((_file_dir+"/1_debugs/").c_str());
